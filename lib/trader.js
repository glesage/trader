...
module.exports = function (fees, placeOrder)
{
    ...
    const minTradeBTC = 0.01;

    const average = new Average(resolution);
    ...
    function sellOrder(price, balanceBTC)
    {
        ...
        const amount = toFixed(balanceBTC, 8);
